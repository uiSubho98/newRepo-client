                        ...
                        <div className="aboutus-container">
                            <div className="aboutus-content lr-pad-d lr-pad-m tb-pad-d tb-pad-m "> 
                                ...
                                <div className="text-c-d">
                                    <img src={imgSrc.list && imgSrc.list[1]} alt="colleges" className="colleges w-100" />
                                </div>
                                <div className="text-c-d text-medium text-faded-2 aboutus-text m-t-64-d m-t-32-m">
                                    We helped them land jobs in Top IT and product companies
                                </div>
                                <div className="text-c-d">
                                    <img src={imgSrc.list && imgSrc.list[2]} alt="companies" className="companies w-100" />
                                </div>
                                <div className="text-c-d text-medium text-faded-2 aboutus-text text-wrap m-t-64-d m-t-32-m">
                                    { "2019 was a milestone year for us in a lot of ways. We launched our ProGrad programs to help bridge\nthe skill gap between academia and the tech industry. These programs saw an overwhelming\nresponse and we were able to help thousands of graduates land their dream tech jobs. This program\nwas also selected to be part of the NEAT (National Educational Alliance for Technology) platform by\nthe Ministry of Education, Govt. of India."}
                                </div>
                                <div className="text-c-d m-t-64-d m-t-32-m">
                                    <img src={imgSrc.list && imgSrc.list[3]} alt="Prograd NEAT" className="pg-neat-img w-100" />
                                </div>
                                <div className="text-c-d text-medium text-faded-2 aboutus-text m-t-64-d m-t-32-m">
                                    TBC
                                </div>
