...
import { BsFacebook,BsInstagram,BsYoutube,BsFillHeartFill,BsBoxSeam,BsChatLeftText } from 'react-icons/bs';
...
<div>
       <Navbar></Navbar>
             <div className="enterprise-banner">
               ...
               <h2>Secure Your Talent Pipeline With Us </h2>
             ...
             <h1 className='text-center'>Ahed of Rivals </h1>
        </div >
