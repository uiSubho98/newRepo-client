...
interface WorkshopCouponsProps {
    
}

const WorkshopCoupons = (props: WorkshopCouponsProps) => {
    ...
    // Fetch coupons for workshop
    useEffect(()=> {
        axios.get(G_API_URL + "admin/coupon/workshop", {
            headers: {
    ...
    return (
        <>
            <div className="workshop-coupons-container">
                <h2 className="h2-heading">Workshop Coupons</h2>
            ...
            <style jsx>
                {`
                    .workshop-coupons-container .options {
...
export default WorkshopCoupons;
